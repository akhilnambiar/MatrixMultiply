...
#pragma omp parallel
    {
#pragma omp for private (j_factor,answer_address,answer_vector0,answer_vector1,answer_vector2,answer_vector3,k_factor,row_int_addr0,column0,row_int0_0,row_int0_1,row_int0_2,row_int0_3)
